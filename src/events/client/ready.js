...
module.exports = class extends Event {
    ...
    run = () => {
        ...
        console.log("\x1b[34m[bot-api] memoryUsage: " + parseInt(memoryUsage().heapTotal / 1024 ** 2) + "/" + parseInt(memoryUsage().rss / 1024 ** 2) + " MB\x1b[0m") //to check memory usage when bot finish load
    }
}